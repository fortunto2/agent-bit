...
- [x] Task 4.1: Update CLAUDE.md: document write-nudge counter fix (reads-since-last-write, threshold 2) and structural task_type forcing for delete-only instructions <!-- sha:pending -->
- [x] Task 4.2: Update `docs/roadmap.md`: mark t03 and t08 progress <!-- sha:pending -->
