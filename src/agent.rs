    ...
    match task_type {
        ...
        "security" => all_defs
            ...
            .filter(|t| {
                matches!(
                    t.name.as_str(),
                    "read" | "read_all" | "search" | "search_and_read" | "grep_count" | "date_calc" | "json_extract" | "find" | "list" | "answer"
                )
            })
            .collect(),
        ...
        "search" if step == 0 => all_defs
            ...
            .filter(|t| {
                matches!(
                    t.name.as_str(),
                    "read" | "read_all" | "search" | "search_and_read" | "grep_count" | "date_calc" | "json_extract" | "find" | "list" | "tree" | "answer" | "context"
                )
            })
            .collect(),
